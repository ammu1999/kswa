...
include 'Connect.php';
$sql="SELECT * from kswatable where username='".$var."' ";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($result);
$id2=$_SESSION['id2']=$row['id'];
...
<p><strong><?php echo "Welcome"." ". $_SESSION['n']; ?></strong>
<?php endif ?>
</div>
<img src="images\Banner_Ed1.gif" style="width:100%">
<ul>
  <li> <a href="paymentgateway.php">Pay</a></li>
...
<li><a href="newconnection.php">Request</a></li>
</ul>
