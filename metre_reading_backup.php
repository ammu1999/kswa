...
$add="INSERT INTO `readings`(`uid`, `consumerno`, `reading`, `date1`, `amount`, `status`,`username`) VALUES ('$id2','$cno','$un','$dt','$cnum','unpaid','$username')";
	 
mysqli_query($conn,$add);
header('location:\watersupply\Paynow.php');
}
?>
<body>
<center>
...
<tr>
				...
				<tr>
								<td>
								<button onclick="amt()">calculate</button
								</td>
							</tr>
		<script >
            function amt(){
			...
			<tr>
				<td><input type="text" id="cal" name="cal" value=""/>
				</td>
			</tr>
					...
					<a href="https://rzp.io/l/2l7hSYpYYe"><button>BILL</button></a>
				</div></div>
